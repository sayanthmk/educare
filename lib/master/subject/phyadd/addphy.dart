...
import 'package:projectedu/master/subject/phyadd/phymodel.dart';

class AddSubPhysics extends StatefulWidget {
  const AddSubPhysics({super.key});

  @override
  State<AddSubPhysics> createState() => _AddSubPhysicsState();
}

class _AddSubPhysicsState extends State<AddSubPhysics> {
  ...
  Future<void> onAddStudentButtonClicked() async {
    ...
    final student = SubjectSetModelPhysics(
